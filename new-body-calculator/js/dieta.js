  ...
  PLATOS_BASE: {
    desayuno: [
      { id:'D01', nombre:'Huevos con tortilla y aguacate', modos:['salvadoreno','economico'],
        comp:[ {c:'A-0003',rol:'prot',min:1,max:3}, {c:'A-0023',rol:'carb',min:1,max:3}, {c:'A-0036',rol:'grasa',min:0.5,max:1.5} ]},
      { id:'D02', nombre:'Huevos con pan y queso', modos:['salvadoreno','economico'],
        comp:[ {c:'A-0003',rol:'prot',min:1,max:3}, {c:'A-0024',rol:'carb',min:1,max:2}, {c:'A-0012',rol:'prot2',min:0.5,max:1.5} ]},
      { id:'D03', nombre:'Yogurt con fruta y avena', modos:['fitness','salvadoreno'],
        comp:[ {c:'A-0014',rol:'prot',min:1,max:2}, {c:'A-0026',rol:'carb',min:0.5,max:1.5}, {rol:'fruta',min:1,max:1} ]},
      { id:'D04', nombre:'Claras con tortilla y frijoles', modos:['fitness','economico'],
        comp:[ {c:'A-0004',rol:'prot',min:2,max:5}, {c:'A-0023',rol:'carb',min:1,max:3}, {c:'A-0016',rol:'prot2',min:0.5,max:1} ]},
      { id:'D05', nombre:'Pan con huevo y jamón', modos:['salvadoreno','fitness'],
        comp:[ {c:'A-0003',rol:'prot',min:1,max:3}, {c:'A-0024',rol:'carb',min:1,max:2}, {c:'A-0085',rol:'prot2',min:1,max:3} ]},
      { id:'D06', nombre:'Avena con nueces y fruta', modos:['fitness'],
        comp:[ {c:'A-0026',rol:'carb',min:1,max:2}, {c:'A-0043',rol:'grasa',min:1,max:2}, {rol:'fruta',min:1,max:1} ]},
      { id:'D07', nombre:'Pupusa con frijoles', modos:['salvadoreno','economico'],
        comp:[ {c:'A-0090',rol:'carb',min:1,max:3}, {c:'A-0016',rol:'prot',min:0.5,max:1} ]},
      { id:'D08', nombre:'Huevos con frijoles y tortilla', modos:['salvadoreno','economico'],
        comp:[ {c:'A-0003',rol:'prot',min:1,max:3}, {c:'A-0023',rol:'carb',min:1,max:3}, {c:'A-0016',rol:'prot2',min:0.5,max:1} ]},
    ],
    almuerzo: [
      { id:'A01', nombre:'Pollo con arroz y ensalada', modos:['salvadoreno','fitness','economico'],
        comp:[ {c:'A-0001',rol:'prot',min:1,max:2}, {c:'A-0021',rol:'carb',min:0.5,max:2}, {rol:'vegetal',min:1,max:1} ]},
      { id:'A02', nombre:'Carne con papa y vegetales', modos:['salvadoreno'],
        comp:[ {c:'A-0005',rol:'prot',min:1,max:2}, {c:'A-0028',rol:'carb',min:0.5,max:2}, {rol:'vegetal',min:1,max:1} ]},
      { id:'A03', nombre:'Pescado con arroz y ensalada', modos:['fitness','salvadoreno'],
        comp:[ {c:'A-0010',rol:'prot',min:1,max:2}, {c:'A-0021',rol:'carb',min:0.5,max:2}, {rol:'vegetal',min:1,max:1} ]},
      { id:'A04', nombre:'Pollo con tortilla y aguacate', modos:['salvadoreno','economico'],
        comp:[ {c:'A-0001',rol:'prot',min:1,max:2}, {c:'A-0023',rol:'carb',min:1,max:3}, {c:'A-0036',rol:'grasa',min:0.5,max:1.5}, {rol:'vegetal',min:1,max:1} ]},
      { id:'A05', nombre:'Carne molida con arroz y frijoles', modos:['salvadoreno','economico'],
        comp:[ {c:'A-0006',rol:'prot',min:1,max:2}, {c:'A-0021',rol:'carb',min:0.5,max:1.5}, {c:'A-0016',rol:'prot2',min:0.5,max:1} ]},
      { id:'A06', nombre:'Muslo de pollo con camote y vegetales', modos:['fitness','salvadoreno'],
        comp:[ {c:'A-0002',rol:'prot',min:1,max:2}, {c:'A-0029',rol:'carb',min:0.5,max:2}, {rol:'vegetal',min:1,max:1} ]},
      { id:'A07', nombre:'Atún con arroz y ensalada', modos:['economico','fitness'],
        comp:[ {c:'A-0008',rol:'prot',min:1,max:2}, {c:'A-0021',rol:'carb',min:0.5,max:2}, {rol:'vegetal',min:1,max:1} ]},
      { id:'A08', nombre:'Cerdo con arroz y frijoles', modos:['salvadoreno'],
        comp:[ {c:'A-0007',rol:'prot',min:1,max:2}, {c:'A-0021',rol:'carb',min:0.5,max:1.5}, {c:'A-0017',rol:'prot2',min:0.5,max:1} ]},
      { id:'A09', nombre:'Camarones con arroz y vegetales', modos:['fitness'],
        comp:[ {c:'A-0011',rol:'prot',min:1,max:2}, {c:'A-0021',rol:'carb',min:0.5,max:2}, {rol:'vegetal',min:1,max:1} ]},
      { id:'A10', nombre:'Pechuga con quinoa y vegetales', modos:['fitness'],
        comp:[ {c:'A-0001',rol:'prot',min:1,max:2}, {c:'A-0022',rol:'carb',min:0.5,max:1.5}, {rol:'vegetal',min:1,max:1} ]},
    ],
    cena: [
      { id:'C01', nombre:'Pollo con vegetales', modos:['fitness','salvadoreno'],
        comp:[ {c:'A-0001',rol:'prot',min:1,max:2}, {rol:'vegetal',min:1,max:1} ]},
      { id:'C02', nombre:'Huevos con aguacate y ensalada', modos:['salvadoreno','economico'],
        comp:[ {c:'A-0003',rol:'prot',min:1,max:3}, {c:'A-0036',rol:'grasa',min:0.5,max:1.5}, {rol:'vegetal',min:1,max:1} ]},
      { id:'C03', nombre:'Atún con ensalada', modos:['fitness','economico'],
        comp:[ {c:'A-0008',rol:'prot',min:1,max:2}, {c:'A-0041',rol:'grasa',min:1,max:2}, {rol:'vegetal',min:1,max:1} ]},
      { id:'C04', nombre:'Carne con vegetales', modos:['salvadoreno','fitness'],
        comp:[ {c:'A-0005',rol:'prot',min:1,max:2}, {rol:'vegetal',min:1,max:1} ]},
      { id:'C05', nombre:'Pescado con camote y vegetales', modos:['fitness'],
        comp:[ {c:'A-0010',rol:'prot',min:1,max:2}, {c:'A-0029',rol:'carb',min:0.5,max:1.5}, {rol:'vegetal',min:1,max:1} ]},
      { id:'C06', nombre:'Huevos con tortilla y frijoles', modos:['salvadoreno','economico'],
        comp:[ {c:'A-0003',rol:'prot',min:1,max:3}, {c:'A-0023',rol:'carb',min:1,max:2}, {c:'A-0016',rol:'prot2',min:0.5,max:1} ]},
      { id:'C07', nombre:'Pollo con arroz', modos:['salvadoreno','economico'],
        comp:[ {c:'A-0001',rol:'prot',min:1,max:2}, {c:'A-0021',rol:'carb',min:0.5,max:1.5} ]},
      { id:'C08', nombre:'Tilapia con vegetales', modos:['fitness'],
        comp:[ {c:'A-0010',rol:'prot',min:1,max:2}, {rol:'vegetal',min:1,max:1} ]},
    ],
  },
  ...
  ajustarFinalIterativo(items, meta) {
    ...
    const ajustar = (cat, macro, accion) => {
      ...
      for (const { it, i } of cands) {
        const maxP = it._compMax || it._maxPorciones || this.maxPorc(it.codigo);
